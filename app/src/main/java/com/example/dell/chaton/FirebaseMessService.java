...
public class FirebaseMessService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String NOTIFICATION_CHANNEL_ID = "chaton_Channel_1";

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "chaton Notifications", NotificationManager.IMPORTANCE_HIGH);
        ...
        notificationBuilder.setAutoCancel(true)
                ...
                .setSmallIcon(R.drawable.chaton1)
