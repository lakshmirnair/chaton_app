...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button saveInfoBtn,UploadIDProof;
    private int check_which_image=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadIDProof = findViewById(R.id.upload_id_proof_button);
        ...
        editPhotoIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                check_which_image=2;// for profile pic
            }
        });
        ...
        UploadIDProof.setOnClickListener(new View.OnClickListener() {
                                             ...
                                             public void onClick(View view) {
                                                 ...
                                                 check_which_image=1;// for id proof
                                             }
                                         }
        );
    ...
    private void saveInformation(String uName, String uNickname, String uPhone, String uProfession, String uGender) {
        if (uGender.length()<1){
            ...
            Toasty.warning(this, "Mobile Number should be minimum 10 characters", 1000).show();
        } else {
