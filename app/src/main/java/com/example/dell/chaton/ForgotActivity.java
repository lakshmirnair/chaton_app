...
public class ForgotActivity extends AppCompatActivity {
        ...
        resetPassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toasty.error(ForgotActivity.this, "Email is required", Toast.LENGTH_SHORT).show();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    Toasty.error(ForgotActivity.this,"Email format is not valid.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void run() {
                                        ForgotActivity.this.runOnUiThread(new Runnable() {
                                            public void run() {
                                                ...
                                                Toasty.info(ForgotActivity.this, "Please check your email.", Toast.LENGTH_LONG).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toasty.error(ForgotActivity.this, "Oops!! "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void emailSentSuccessPopUp() {
        ...
        View view = LayoutInflater.from(ForgotActivity.this).inflate(R.layout.registerpopup, null);
